...
class ColorManager {
  ...
  static const Color secondry = Color(0xffCEFF3D);

  static const Color green = Color(0xff008000);
  static const Color successGreen = Color(0xff20B431);
  ...
  static const Color lightBlackText = Color(0xff48484A);
  static const Color blackText = Color(0xff030303);
  static const Color red = Color(0xffEA2626);
  ...
  static const List<Color> gradientPrimary = [Color(0xff2563EB), Color(0xff1A4DBF)];
  static const Color lightGreen = Color(0xffE8F5E9);
  static const Color lightPrimary = Color(0xffE0E7FF);
