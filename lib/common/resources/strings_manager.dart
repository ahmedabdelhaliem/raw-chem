class AppStrings {
  ...
  //textFieldError
  static const String textFieldError = "Please enter a valid text";
  //=unKnownError
  //=serverConnectionError
  static const String serverConnectionError = "Server connection error";
  //=noDataFound
  ...
  static const String invalidPhoneNumberLength = "Invalid phone number length";
  //==downloadFailed
  ...
  //==loginFirstMessage
  static const String loginFirstMessage = "Please login first to use this feature";
  //==loginFirstTitle
  static const String loginFirstTitle = "Login first";
  //==login
  static const String login = "Login";
  //==register
  static const String register = "Register";
  //==chooseFromGallry
  static const String chooseFromGallry = "Choose from gallery";
  //==takeImage
