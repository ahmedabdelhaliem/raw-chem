...
class SearchableDropdownMenuWidget extends StatefulWidget {
  ...
  @override
  State<SearchableDropdownMenuWidget> createState() => _SearchableDropdownMenuWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return widget.enabled
        ...
        : DropdownMenu(
            ...
            textStyle: Theme.of(context).textTheme.bodySmall?.copyWith(color: ColorManager.black),
            ...
            dropdownMenuEntries: widget.items
                .map((e) => DropdownMenuEntry(
                    value: e.courseId, label: widget.isName ? (e.name ?? '') : e.nameAr))
                .toList(),
