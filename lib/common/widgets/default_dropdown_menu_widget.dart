...
class DefaultDropdownMenuWidget<T> extends StatefulWidget {
  ...
  @override
  State<DefaultDropdownMenuWidget<T>> createState() => _DefaultDropdownMenuWidgetState<T>();
}
              ...
              DropdownButtonHideUnderline(
                child: DropdownButton2(
                  ...
                  hint: Text(
                    widget.hintText,
                    style:
                        widget.hintStyle ?? getBoldStyle(color: ColorManager.grey, fontSize: 10.sp),
                  ),
                  items: widget.items
                      .map((item) => DropdownMenuItem<T>(
                            ...
                            child: Text(
                              ...
                              style:
                                  getSemiBoldStyle(fontSize: 13.sp, color: ColorManager.textColor),
                            ),
                          ))
                      .toList(),
                  ...
                  buttonStyleData: ButtonStyleData(
                    padding: EdgeInsets.symmetric(horizontal: widget.isSmall == true ? 2.w : 10.w),
                    width: widget.width,
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: widget.text == null ? ColorManager.grey : ColorManager.black),
                ),
                if (widget.withSuffixIcon) const Spacer(),
                if (widget.withSuffixIcon)
                  Container(
                    decoration:
                        const BoxDecoration(color: ColorManager.primary, shape: BoxShape.circle),
                    child: const Icon(
                      Icons.keyboard_arrow_down,
                      color: ColorManager.white,
                    ),
