      ...
      child: Column(
        ...
        children: [
          if (widget.title != null)
            Text(
              ...
              style: widget.titleStyle ??
                  getMediumStyle(fontSize: 15.sp, color: ColorManager.textColor),
            ),
          if (widget.title != null)
            SizedBox(
              height: 5.h,
          ...
          TextFormField(
            ...
            textDirection:
                widget.inLeft ?? (language == 'en') ? ui.TextDirection.ltr : ui.TextDirection.rtl,
            ...
            inputFormatters: widget.withInputFormatter
                ...
                : widget.maxLength != null
                    ...
                    : null,
            // cursorHeight: 25.h,
            style: widget.textStyle ?? getBoldStyle(fontSize: 14.sp, color: ColorManager.textColor),
            validator: widget.withValidate
                ? (value) {
                    String? customError = widget.validator?.call(value);
            ...
            decoration: InputDecoration(
              ...
              labelStyle:
                  TextStyle(color: ColorManager.grey, fontSize: 12.sp, fontWeight: FontWeight.bold),
              contentPadding: widget.verticalPadding != null
                  ? EdgeInsets.symmetric(vertical: widget.verticalPadding!, horizontal: 15.w)
                  : null,
              filled: true,
              ...
              focusedBorder: widget.noBorder
                  ...
                  : widget.isUnderLine
                      ? UnderlineInputBorder(
                          borderSide:
                              BorderSide(color: widget.borderColor ?? ColorManager.greyBorder),
                        )
                      : OutlineInputBorder(
              ...
              errorBorder: widget.noBorder
                  ...
                  : widget.isUnderLine
                      ? UnderlineInputBorder(
                          borderSide: BorderSide(color: widget.borderColor ?? ColorManager.red),
                        )
                      : OutlineInputBorder(
                          borderRadius: BorderRadius.circular(widget.borderRadius ?? 8.r),
