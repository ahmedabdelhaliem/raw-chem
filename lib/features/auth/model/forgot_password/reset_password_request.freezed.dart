...
class _$ResetPasswordRequestImpl implements _ResetPasswordRequest {
  ...
  @override
  String toString() {
    return 'ResetPasswordRequest(phone: $phone, token: $token, password: $password, passwordConfirmation: $passwordConfirmation)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, phone, token, password, passwordConfirmation);
